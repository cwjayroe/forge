...
export default function Settings() {
                  ...
                  placeholder={`[
  {
    ...
    "require_plan_validation_pass": true
        ...
        <div className="flex items-center gap-3 pt-5 mt-5 border-t border-gray-700">
          <button
            type="submit"
            disabled={saving}
...
function TabBar({ tabs, active, onChange }) {
  return (
    <div className="flex border-b border-gray-700 mb-5 -mx-6 px-6 overflow-x-auto">
      {tabs.map((tab) => (
        <button
          key={tab.id}
          type="button"
